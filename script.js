const tableData = [];
const newrowbut = document.getElementById("new-row-btn")
const tablebody = document.getElementById("hii")

function submitdata(name, roll, subject, marks, markedby) {
	newrowbut.disabled = false
...
newrowbut.addEventListener("click", () => {
  ...
  <td><button id="save" onclick="submitdata(document.getElementById('stuname').value,document.getElementById('rollno').value,document.getElementById('subject').value,document.getElementById('marks').value,document.getElementById('markedby').value)">Save</button></td>
  </form>`

	newrowbut.disabled = true
})